            ...
            <div class="mt-2">
                <div class="border-b border-gray-200 ">
                    <div class="-mb-px flex space-x-8 px-4 justify-around" aria-orientation="horizontal" role="tablist">
                        ...
                        <button id="men" onClick={handleClick} value="men's clothing" class="border-transparent text-gray-900 flex-1 whitespace-nowrap border-b-2 px-1 py-4 text-base font-medium" aria-controls="tabs-1-panel-1" role="tab" type="button">Men</button>
                        <button id="women" onClick={handleClick} value="women's clothing" class="border-transparent text-gray-900 flex-1 whitespace-nowrap border-b-2 px-1 py-4 text-base font-medium" aria-controls="tabs-1-panel-1" role="tab" type="button">Women</button>
