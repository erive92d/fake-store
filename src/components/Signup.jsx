...
export default function Signup() {
    ...
    return (
        ...
        <div class="flex min-h-screen flex-col  px-6 py-12 lg:px-8">
            ...
            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <form class="space-y-6" action="#" method="POST">
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <input id="username" name="username" type="username" autocomplete="current-username" required class="block w-full rounded-md border-0 p-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" onChange={handleChange} />
                        </div>
                    </div>
